...
public class EmailSender {
	public static void main(String[] args) {
		final String senderEmail = "thogarchitirammohan@gmail.com";
		final String appPassword = "efkbockpgbhhilom";
		final String recipientEmail = "thogarchitirammohan@gmail.com";
